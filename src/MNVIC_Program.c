...
/*                                                                                     */
/* Description:                                                                        */
/* Nested Vectored Interrupt Controller (NVIC) driver for STM32 microcontrollers.      */
/* Handles interrupt enable/disable, priority configuration, and pending flags.        */
/*                                                                                     */
/* Features:                                                                           */
/*   - Enables/disables NVIC interrupts.                                               */
/*   - Sets/clears pending flags.                                                      */
/*   - Reads active interrupt state.                                                   */
/*   - Configures group and subgroup priorities.                                       */
/***************************************************************************************/
