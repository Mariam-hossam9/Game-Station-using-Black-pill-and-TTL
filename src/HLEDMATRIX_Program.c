...
/* File      : HLEDMATRIX_Program.c                                                    */
/* Date      : August 21, 2025                                                         */
/* Version   : V1.0                                                                    */
/*                                                                                     */
/* Description:                                                                        */
/* This file provides the driver implementation for controlling an 8x8 LED Matrix      */
/* using GPIO pins and multiplexing techniques. It supports initialization and         */
/* display functions for showing patterns and animations.                              */
/*                                                                                     */
/* Features:                                                                           */
/*   - Configures row and column pins as output.                                       */
/*   - Sets individual row values for display.                                         */
/*   - Activates and deactivates columns dynamically.                                 */
/*   - Displays a pattern from an array buffer.                                        */
/*                                                                                     */
/* Usage:                                                                              */
/*   1. Call `HLEDMATRIX_voidInit()` to initialize the LED Matrix pins.                */
/*   2. Use `HLEDMATRIX_voidDisplay(pattern)` to display a pattern on the matrix.      */
/***************************************************************************************/
